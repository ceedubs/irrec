...
// Copied from https://github.com/typelevel/cats-testkit-scalatest/blob/master/core/src/main/scala/cats/tests/CatsEquality.scala
// Copied because there is not yet a stable release of this library.
// which in turn was taken and only slightly modified from
